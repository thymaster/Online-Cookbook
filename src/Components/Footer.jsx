          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">
                <a href="https://www.google.com" className="text-gray-600 hover:text-gray-800">ABOUT US</a> 
              </h2>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">
                <a href="https://www.google.com" className="text-gray-600 hover:text-gray-800">PRIVACY POLICY</a> 
              </h2>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">
                <a href="https://www.google.com" className="text-gray-600 hover:text-gray-800">CONTACT US</a> 
              </h2>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">
                <a href="https://www.google.com" className="text-gray-600 hover:text-gray-800">TERMS AND CONDITIONS</a> 
              </h2>
            </div>
          </div>
        </div>
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            ...
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <a  href="https://twitter.com/Anish16065" className="ml-3 text-gray-500">
                <svg
                  fill="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a href="https://www.instagram.com/commandercoriandersalamander/" className="ml-3 text-gray-500">
                <svg
                  fill="none"
                  stroke="currentColor"
                  stroke-linecap="round"
              ...
              <a href="https://www.linkedin.com/in/anish-sarkar-6a3282152/" className="ml-3 text-gray-500">
                <svg
                  fill="currentColor"
                  stroke="currentColor"
                  stroke-linecap="round"
